...
class MessageParserTest {
    ...
    @Test
    fun `should parse a multiline system message`() {
        val line =
        ...
        val message = MessageParser("M/d/yy, HH:mm").parse(line) { it }
        val expected = Message(
            createdAt = LocalDateTime.of(2024, 11, 20, 13, 55),
            author = Author(
                name = "",
                type = AuthorType.SYSTEM
            ),
            ...
            content = Content(
                attachment = null,
                text = "Only messages that mention or people share with @AI can be read by Meta. Meta can't read any other messages in this chat, as your personal messages remain end-to-end encrypted.\n\nMessages are generated by AI. Some may be inaccurate or inappropriate. *Learn more*"
            )
        )
